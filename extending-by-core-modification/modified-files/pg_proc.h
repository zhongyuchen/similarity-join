...
DATA(insert OID = 9997 (  jaccard_index  			 PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 700 "25 25" _null_ _null_ _null_ _null_ _null_ jaccard_index _null_ _null_ _null_));
DESCR("jaccard_index");
DATA(insert OID = 9998 (  levenshtein_distance  		 PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 23 "25 25" _null_ _null_ _null_ _null_ _null_ levenshtein_distance _null_ _null_ _null_));
DESCR("levenshtein_distance");
DATA(insert OID = 9999 (  levenshtein_distance_2  		 PGNSP PGUID 12 1 0 0 0 f f f f t f i s 3 0 16 "25 25 23" _null_ _null_ _null_ _null_ _null_ levenshtein_distance_2 _null_ _null_ _null_));
